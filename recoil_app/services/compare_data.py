...
Overlay-графики (4 фрагмента Plotly) и дельта-таблица 12 метрик.
Графики строит `services.charting`, эта прослойка только собирает входные данные
и проводит их в нужный шаблон фрагмента.
"""
...
def build_compare_overlay_charts(run_a: CalculationRun, run_b: CalculationRun) -> dict:
    """4 overlay-фрагмента Plotly: x(t), v·a(t), v(x), F_маг(v)."""
